...
class MenuItemModel extends AdminModel
{
    ...
    public function __construct($attributes = [])
    {
        ...
        $this->_data = [
            'listField' => [
                ...
                'res.name AS  restaurant_id' => 'restaurant_id',
                'c.name AS  category_id' => 'category_id',
    ...
    public function listItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-index") {
            ...
            $query = self::select(array_keys($this->_data['listField']))
                ...
                ->leftJoin(TABLE_CMS_MENU_CATEGORY . ' AS c', 'c.id', '=', $this->table . '.category_id')
                ->leftJoin(TABLE_CMS_RESTAURANT . ' AS res', 'res.id', '=', $this->table . '.restaurant_id')
                ;
