...
class CoinRuleModel  extends AdminModel
{
    ...
    public function __construct($attributes = [])
    {
        ...
        $this->_data        = [
            'listField' => [
                $this->table . '.id'                => 'id',
                $this->table . '.rule_name'         => 'Rule name',
                $this->table . '.coin_amount'       => 'Coin amount',
