...
class VoucherModel  extends AdminModel
{
    ...
    public function __construct($attributes = [])
    {
        ...
        $this->_data        = [
            'listField' => [
                ...
                $this->table . '.date_start'        => 'Date_start',
                $this->table . '.date_end'          => 'Date_end',
                $this->table . '.discount_amount'   => 'Discount_amount',
                $this->table . '.minimum_price'     => 'Minimum_price',
    ...
    public function adminQuery(&$query, $params)
    {
        ...
        $dataEqua = [
            ...
            [
                'field' =>  $this->table . '.date_start',
                'value' => 'date_start'
            ],
            [
                'field' =>  $this->table . '.date_end',
                'value' => 'date_end'
            ],
            [
                'field' =>  $this->table . '.discount_amount',
                'value' => 'discount_amount'
            ],
            [
                'field' =>  $this->table . '.minimum_price',
                'value' => 'minimum_price'
            ],
        ];
