...
class CategoryPostModel  extends AdminModel
{
    ...
    public function __construct($attributes = [])
    {
        ...
        $this->_data        = [
            'listField' => [
                ...
                'p.name AS post_type_id'            => 'Post Type',
    ...
    public function listItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-index") {
            ...
            $TABLE_POST_TYPE = config('constants.table.ecommerce.TABLE_POST_TYPE');
            $query                          = self::select(array_keys($this->_data['listField']))
                ...
                ->leftJoin($TABLE_POST_TYPE . ' AS p', 'p.id', '=', $this->table . '.post_type_id');
    ...
    public function columnIcon($params, $field, $val)
    {
