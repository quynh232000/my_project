...
class PartnerRegisterModel extends AdminModel
{
    ...
    public function columnStatus($params, $field, $val)
    {
        ...
        return '<div class="d-flex justify-content-center "><div style="min-width:80px !important" class="badge d-flex justify-content-center text-center badge-' . $class . ' text-white">' . $value . '</div> </div>';
    }
    ...
    public function getActionButton($params, $data,  $val, $options = null)
    {
        ...
        $icon   = $val['status'] == 'pending' ? '<i class="fa-sharp fa-solid fa-solid fa-check-to-slot text-info fa-lg btn-choose-ticket"></i>' : '<i class="fa-sharp fa-solid fa-pen-to-square text-info fa-lg "></i>';
