...
class WardModel  extends AdminModel
{
    ...
    public function __construct($attributes = [])
    {
        ...
        $this->_data        = [
            'listField' => [
                ...
                'p.name AS province_code'           => 'province',
    ...
    public function listItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-index") {
            ...
            $TABLE_PROVINCE = config('constants.table.general.TABLE_PROVINCE');
            $query                          = self::select(array_keys($this->_data['listField']))
                ->leftJoin($TABLE_USER . ' AS u', 'u.id', '=', $this->table . '.created_by')
                ->leftJoin($TABLE_PROVINCE . ' AS p', 'p.province_code', '=', $this->table . '.province_code')
