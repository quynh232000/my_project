...
use App\Http\Requests\Hotel\HotelCategoryRequest;
use App\Models\Hotel\HotelCategoryModel;
use Illuminate\Http\Request;

class HotelCategoryController extends AdminController
{
    protected $data = [];
    public $model;
    ...
    public function create()
    {
        ...
        $this->_params['categories'] = $this->model->getItem($this->_params,['task' => 'get-all']);
        return view($this->_viewAction, ['params' => $this->_params,]);
    }
    ...
    public function update(HotelCategoryRequest $request)
    {
    ...
    {
        return response()->json(array('success' => HotelCategoryModel::findOrFail($id)->$act(),'message' => 'Cập nhật thông tin thành công'));
