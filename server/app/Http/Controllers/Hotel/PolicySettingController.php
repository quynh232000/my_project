...
use App\Http\Requests\Hotel\SettingPolicyRequest;
use App\Models\Hotel\PolicySettingModel;
use Illuminate\Http\Request;

class PolicySettingController extends AdminController
{
    public $model;
    public function __construct(Request $request)
    {
        parent::__construct($request);
        $this->model = new PolicySettingModel();
    }
    ...
    public function store(SettingPolicyRequest $request)
    {
    ...
    public function update(SettingPolicyRequest $request,$id)
    {
        $this->_params[$this->model->columnPrimaryKey()] = $id;
