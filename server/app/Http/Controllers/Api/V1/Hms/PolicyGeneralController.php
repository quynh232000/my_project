...
use App\Http\Requests\Api\V1\Hms\PolicyGeneral\UpdateRequest;
use App\Models\Api\V1\Hms\PolicyGeneralModel;
use Illuminate\Http\Request;


class PolicyGeneralController extends HmsController
{
    protected $data = [];
    public $model;
    ...
    public function __construct(Request $request)
    {
        ...
        $this->model = new PolicyGeneralModel();
    }
    ...
    {
        try {
            $result = $this->model->getItem($this->_params,['task' => 'item-info']);
