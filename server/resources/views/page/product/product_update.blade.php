                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="/">Quản trị</a></li>
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('product.list') }}">Sản
                                    phẩm</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name"
                                value="{{ old('name') ?? $product->name }}" id="productNameLabel"
                                placeholder="Áo thun nam..." aria-label="Shirt, t-shirts, etc.">
                            @error('name')
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('origin') ?? $product->origin }}"
                                        class="form-control" name="origin" id="origin"
                                        placeholder="Việt Nam, Trung Quốc,.." aria-label="eg. 348121032">
                                    @error('origin')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input value="{{ old('brand_value') ?? $product->brand->name }}" type="text"
                                            class="form-control" name="brand_value" id="brand"
                                            placeholder="Aple, Gucci,.." aria-label="0.0">
                                            ...
                                            <div id="brand_select" class="select2-custom select2-custom-right">
                                                <select class="js-select2-custom custom-select" size="1"
                                                    ...
                                                    @foreach ($brands as $item)
                                                        <option
                                                            {{ old('brand_id') == $item->id ? 'selected' : ($product->brand_id == $item->id ? 'selected' : '') }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control"
                                        value="{{ old('price') ?? explode('.', $product->price)[0] }}" name="price"
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control"
                                        value="{{ old('percent_sale') ?? $product->percent_sale }}" name="percent_sale"
                                        id="percent_sale" placeholder="0" value="0" aria-label="">
                                </div>
                                <!-- End Form Group -->
                            </div>
                        </div>
                        ...
                        <div class="quill-custom">
                            ...
                            <input type="text"value="{{ old('description') ?? $product->description }}"
                                id="input_description" name="description" hidden>
                            @error('description')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <input type="text" class="form-control" name="attribute_name[]"
                                                    id="" value="{{ $attribute_item->attribute_name->name }}"
                                                    placeholder="Chất liệu,.." aria-label="0.0">
                                                ...
                                                <div>
                                                    <select class=" form-control" name="attribute_name_id[]">
                                                        ...
                                                        @foreach ($attribute_names as $item)
                                                            <option
                                                                {{ $attribute_item->attribute_name->id == $item->id ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <input type="text" value="{{ $attribute_item->value }}"
                                                    name="attribute_value[]" placeholder="Aa.." class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" class="js-select2-custom custom-select" size="1"
                                ...
                                @foreach ($categories as $item)
                                    <option
                                        {{ old('category_id') == $item->id ? 'selected' : ($product->category_id == $item->id ? 'selected' : '') }}
                                        value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                            @error('category_id')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" value="{{ old('stock') ?? $product->stock }}"
                                            class="form-control" name="stock" id="stock" placeholder="0.00"
                                            aria-label="0.00">
                                    </div>
                                    @error('stock')
                                        <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" value="{{ old('priority') ?? $product->priority }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number"
                                            value="{{ old('length') ? old('length') : $product->shipping->length }}"
                                            class="form-control" name="length" id="length" placeholder="0"
                                            aria-label="0.00">
                                    </div>
                                    @error('length')
                                        <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            value="{{ old('width') ? old('width') : $product->shipping->width }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            value="{{ old('height') ? old('height') : $product->shipping->height }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            value="{{ old('weight') ? old('weight') : $product->shipping->weight }}"
