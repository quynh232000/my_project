                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('dashboard') }}">Trang
                                    chủ</a></li>
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('marketing.voucher.list') }}">Khuyến mãi
                                </a></li>
                            <li class="breadcrumb-item active" aria-current="page">Khuyến mãi mới</li>
                        </ol>
                    </nav>

                    <h1 class="page-header-title">Thêm khuyến mãi mới</h1>
                </div>
            </div>
            <!-- End Row -->
        </div>
                        ...
                        <form method="post" id="addUserStepProfile" class="card card-lg active"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('name') }}"
                                                name="name" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('code') }}"
                                                name="code" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('code')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="datetime-local" class="form-control" value="{{ old('date_start') }}"
                                                name="date_start" placeholder="1,2" aria-label="Clarice" value="1" />
                                        </div>
                                        @error('date_start')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="datetime-local" class="form-control" value="{{ old('date_end') }}"
                                                name="date_end" placeholder="1,2" aria-label="Clarice" value="1" />
                                        </div>
                                        @error('date_end')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="number" class="form-control" value="{{ old('discount_amount') }}"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('minimum_price') }}"
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="number" class="form-control" value="{{ old('quantity') }}"
                                                name="quantity" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('quantity')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="number" class="form-control" value="{{ old('max_usage_per_user') }}"
