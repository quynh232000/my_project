                        ...
                        <form method="post" id="addUserStepProfile" class="card card-lg active"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-9">
                                        <label for="avatarUploader" class="d-flex flex-direction-column align-items-center"
                                            ...
                                            <img style="width: 100%; height:240px;object-fit:cover" id="avatarImg"
                                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuhbWlk8tthY7Vxi4kA0xNjC1YK0WtFc-f4A&s"
                                                alt="">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('title') }}"
                                                name="title" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('title')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('alt') }}"
                                                name="alt" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('alt')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <textarea name="description" class="form-control" placeholder="Aa.." id="" cols="30" rows="3">{{ old('description') }}</textarea>
                                        </div>
                                        @error('description')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('link_to') }}"
                                                name="link_to" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('link_to')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('placement') }}"
                                                name="placement" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('placement')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" value="{{ old('type') }}"
                                                name="type" placeholder="Aa.." aria-label="Clarice" />
                                        </div>
                                        @error('type')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="date" class="form-control" value="{{ old('expired_at') }}"
                                                name="expired_at" placeholder="1,2" aria-label="Clarice"
                                                value="1" />
                                        </div>
                                        @error('expired_at')
                                            <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="number" class="form-control" value="{{ old('priority') }}"
                                                name="priority" placeholder="1,2" aria-label="Clarice" value="1" />
                                        </div>
                                        @error('priority')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
