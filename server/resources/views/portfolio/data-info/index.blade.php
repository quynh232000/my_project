    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card card-flush">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="{{ route($params['prefix'] . '.' . $params['controller'] . '.create') }}" type="button"
                            ...
                            <i class="ki-outline ki-plus fs-2"></i>Add Data Info</a>
                        <!--end::Add user-->
                    </div>
            ...
            <div class="card-body pt-0">
                ...
                <div class="container">
                    <h1 class="mb-4">List Data Info ({{$params['items']->total()}})</h1>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="icon-wrapper cursor-pointer symbol symbol-40px">
                                                  <img src="{{ $item->avatar ?? asset('assets/media/auth/505-error.png') }}"
                                                        alt="">
                                            </span>
