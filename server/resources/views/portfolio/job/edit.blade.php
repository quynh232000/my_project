                        ...
                        <div class="card-body">
                            <div class="row m-0  pt-2">
                                ...
                                <div class="form-group col-md-6 p-2 mb-0">
                                    ...
                                    {!! \App\Models\Portfolio\JobModel::stateSelect($params['item']['status'] ?? '') !!}
                                    <div class="input-error "></div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row m-0  pt-2">
                                <div class="form-group col-12 p-2 mb-0">
                                    ...
                                    <x-admin.input.upload :name="'cv_link'" :accept="'*'" :url="$params['item']['cv_url'] ?? ''"></x-admin.input.upload>
                                </div>
                                <div class="form-group col-12 p-2 mb-0">
