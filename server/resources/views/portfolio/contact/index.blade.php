                ...
                <div class="w-100">
                    ...
                    <form class="d-flex align-items-center position-relative my-1 row">
                        ...
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                            ...
                            <input type="text" name="email_contact" class="form-control mb-2" placeholder="Enter..."
                                value="{{ request()->email_contact ?? '' }}">
                        </div>
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                        ...
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                            ...
                            <input type="text" name="content" class="form-control mb-2" placeholder="Enter..."
