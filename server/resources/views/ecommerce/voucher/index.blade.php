                ...
                <div class="w-100">
                    ...
                    <form class="d-flex align-items-center position-relative my-1 row">
                        ...
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                            ...
                            {!! \App\Models\Ecommerce\VoucherModel::slbStatus($params['status'] ?? '') !!}
                        </div>
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                            <label class=" form-label">Date Start</label>
                            <input type="date" name="date_start" class="form-control mb-2" placeholder="Enter..."
                                value="{{ request()->date_start ?? '' }}">
                        </div>
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                            <label class=" form-label">Date end</label>
                            <input type="date" name="date_end" class="form-control mb-2" placeholder="Enter..."
                                value="{{ request()->date_end ?? '' }}">
                        </div>
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                            <label class=" form-label">Discount</label>
                            <input type="text" name="discount_amount" class="form-control mb-2" placeholder="Enter..."
                        ...
                        <div class="mb-2 fv-row fv-plugins-icon-container col-md-3">
                            ...
                            <input type="text" name="shop_name" class="form-control mb-2" placeholder="Enter..."
