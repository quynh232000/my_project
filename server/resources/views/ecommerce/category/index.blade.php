                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="{{ route($params['prefix'] . '.' . $params['controller'] . '.create') }}" type="button"
                            ...
                            <i class="ki-outline ki-plus fs-2"></i>Add Data</a>
                        <!--end::Add user-->
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td> <div class="d-flex align-items-center">
                                        <span class="icon-wrapper cursor-pointer symbol symbol-40px">
                                            <img src="{{ !empty($item->icon_url)?$item->icon_url:  asset('assets/media/auth/505-error.png') }}" alt="">
                                        </span>

                                    </div></td>
                                    <td>{{ $item->name }}</td>
                                    <td>{{ $item->slug }}</td>
                                    <td>{{ $item->created_at?->format('d/m/Y H:i')??'_' }}</td>
                                    <td>{{ $item->creator?->full_name ?? '_'  }}</td>
                                    <td>
                                        <a href="
