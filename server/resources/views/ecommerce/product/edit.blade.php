        ...
        <div class="card card-flush">
            ...
            <div class="modal-content">
                ...
                <div class=" mx-lg-5 my-7">
                    <form  id="admin-{{ $params['prefix'] }}-form"
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                        ...
                                        <div class="image-input-wrapper w-150px h-150px"
                                            style="background-image: url({{$params['item']->image ?? asset('assets/media//stock/ecommerce/78.png')}})"></div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <!--begin::Select2-->
                                    {!!\App\Models\Ecommerce\ProductModel::selectStatus($params['item']->status ?? '')!!}
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                      {!!\App\Models\Ecommerce\ProductModel::selectCategory($params['item']->category_id ?? '')!!}
                                    ...
                                    <!--end::Input group-->
                                    <!--begin::Button-->
                                    <a href="{{route($params['prefix'] . '.category.create')}}"
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Currency-->
                                            <!--begin::Amount-->
                                            <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">{{$params['item']->sold}}</span>
                                            <!--end::Amount-->
                                            <!--begin::Badge-->
                                            <span class="badge badge-light-success fs-base">
                                                <i class="ki-outline ki-arrow-up fs-5 text-success ms-n1"></i>{{($params['item']->sold/$params['item']->stock)*100}} %</span>
                                            <!--end::Badge-->
                                        </div>
                                        <!--end::Info-->
                                        <!--begin::Subtitle-->
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <input type="text" name="name" class="form-control mb-2"
                                                        placeholder="Product name" value="{{$params['item']->name}}" />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
