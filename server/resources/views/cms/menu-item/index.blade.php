...
@php
    $model = $params['model'];
@endphp
@section('title', trans('Danh sách chuỗi thương hiệu'))
@section('main')
                        ...
                        <div class="row m-0 pt-2">
                            <div class="col-12 row">
                                <div class="form-group col-3 p-2 mb-0">
                                    <label class="font-weight-normal" for="status">Loại</label>
                                ...
                                <div class="form-group col-3 p-2 mb-0">
                                    <label for="name" class="font-weight-normal">Tên chuỗi</label>
                                ...
                                <div class="form-group col-3 p-2 mb-0">
                                    ...
                                    {!! \App\Models\Hotel\ChainModel::slbStatus(
