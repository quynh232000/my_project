                        ...
                        <div class="row m-0 pt-2">
                            <div class="form-group col-sm-3 p-2 mb-0">
                                ...
                                <input id="code" name="code"
                                    ...
                                    type="text" class="form-control event-enter" placeholder="Nhập code">
                            </div>
                            <div class="form-group col-sm-3 p-2 mb-0">
                                <label for="title" class="font-weight-normal">Tên khách sạn</label>
                                <input id="title" name="title"
                                    value="{{ isset($params['title']) && !empty($params['title']) ? $params['title'] : '' }}"
                            ...
                            <div class="form-group col-sm-3 p-2 mb-0">
                                ...
                                <input id="email" name="email"
                                    value="{{ isset($params['email']) && !empty($params['email']) ? $params['email'] : '' }}"
                                    type="text" class="form-control event-enter" placeholder="Nhập email">
                            </div>
                            <div class="form-group col-sm-3 p-2 mb-0">
                                <label for="phone" class="font-weight-normal">Số điện thoại</label>
                                <input id="phone" name="phone"
                                    value="{{ isset($params['phone']) && !empty($params['phone']) ? $params['phone'] : '' }}"
                                    type="text" class="form-control event-enter" placeholder="Nhập số điện thoại">
                            </div>
                            ...
                            <div class="row col-12">
                                ...
                                <div class="form-group col-sm-3 p-2 mb-0">
                                    ...
                                    <input id="created_at" name="created_at"
                                        ...
                                        type="date" class="form-control event-enter" placeholder="">
                                </div>
                                <div class="form-group col-sm-3 p-2 mb-0">
