                ...
                <form class="form-horizontal" method="GET" enctype="multipart/form-data" id="admin-form-{{$params['prefix']}}-{{$params['controller']}}" name="admin-form-{{$params['prefix']}}-{{$params['controller']}}">
                    <div class="row m-0 pt-2">
                        <div class="form-group col-sm-3 p-2 mb-0">
                            ...
                            <input id="bank" name="bank" value="{{isset($params['bank']) && !empty($params['bank']) ? $params['bank'] : ''}}" type="text" class="form-control event-enter" placeholder="Nhập bank">
                        </div>
                        <div class="form-group col-sm-3 p-2 mb-0">
                            <label for="hotel" class="font-weight-normal">Tên khách sạn</label>
                            <input id="hotel" name="hotel" value="{{isset($params['hotel']) && !empty($params['hotel']) ? $params['hotel'] : ''}}" type="text" class="form-control event-enter" placeholder="Nhập tên khách sạn">
                        </div>
                        <div class="form-group col-sm-3 p-2 mb-0">
                            <label for="name_account" class="font-weight-normal">Tên tài khoản</label>
                            <input id="name_account" name="name_account" value="{{isset($params['name_account']) && !empty($params['name_account']) ? $params['name_account'] : ''}}" type="text" class="form-control event-enter" placeholder="Nhập họ tên">
                        </div>
                        <div class="form-group col-sm-3 p-2 mb-0">
                            <label for="number" class="font-weight-normal">Số tài khoản</label>
                            <input id="number" name="number" value="{{isset($params['number']) && !empty($params['number']) ? $params['number'] : ''}}" type="text" class="form-control event-enter" placeholder="Nhập Số tài khoản">
                        </div>
