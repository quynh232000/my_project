                        ...
                        <div class="card-body">
                            <div class="row m-0  pt-2">
                                ...
                                <div class="form-group col-12 p-2 mb-0">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="4" placeholder="Nhập description.."></textarea>
                                    <div class="input-error"></div>
                                </div>
                                ...
                                <div class="form-group col-12 p-2 mb-0">
                                    ...
                                    {!! \App\Helpers\Template::InputText($params, 'content') !!}
                                    <div class="input-error"></div>
                                </div>
                            ...
                            <div class="row m-0  pt-2">
                                ...
                                <div class="form-group col-12 p-2 mb-0">
                                    <label class="col-form-label text-right" for="meta_description">Meta
                                        description</label>
                                    <textarea rows="4" class="form-control" name="meta_description" id="meta_description"
