...
@section('main')
    ...
    <form class="form-horizontal app-container" id="admin-{{ $params['prefix'] }}-form" name="admin-{{ $params['prefix'] }}-form"
        ...
        action="{{ route($params['prefix'] . '.' . $params['controller'] . '.update', ['attribute' => $params['item']['id']]) }}">
                    ...
                    <div class="card-body">
                        <div class="row m-0  pt-2">
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="name">Tên<span style="color: red">(*)</span></label>
                            ...
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <input type="text" class="form-control " id="name_en" name="name_en"
                                    placeholder="Nhập tiêu đề" value="{{ $params['item']['name_en'] }}">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                            ...
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <select class="form-control" id="parent_id" name="parent_id">
                                    ...
                                    {!! \App\Models\Hotel\AttributeModel::treeSelectCategory($parentCategories,$params['item']['parent_id'],$params['item']['id']) !!}
                            ...
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                {!! \App\Models\Hotel\AttributeModel::slbStatus($params['item']['status']) !!}
                                <div class="input-error"></div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#admin-{{ $params['prefix'] }}-form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route($params['prefix'] . '.' . $params['controller'] . '.update', ['attribute' => $params['item']['id']]) }}",
                    data: formData,
                    headers: {
