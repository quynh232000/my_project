...
@section('main')
    ...
    <form class="form-horizontal app-container" id="admin-{{ $params['prefix'] }}-form" name="admin-{{ $params['prefix'] }}-form"
        ...
        action="{{ route($params['prefix'] . '.' . $params['controller'] . '.update', ['post' => $params['item']['id']]) }}">
                    ...
                    <div class="card-body">
                        <div class="row m-0  pt-2">
                            ...
                            <div class="form-group col-12 p-2 mb-0">
                                ...
                                <textarea class="form-control" name="description" id="description"  placeholder="Nhập mô tả">{{$params['item']['description']}}</textarea>
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-12 p-2 mb-0">
                    ...
                    <div class="row m-0  pt-2">
                        <div class="form-group col-9 p-2 mb-0">
                            ...
                            id="category_id" name="category_id[]" multiple>
                                ...
                                {!! \App\Models\Hotel\PostModel::treeSelectCategory($params['categories'], $params['categoryIds']) !!}
                            </select>
                            <div class="input-error"></div>
                        </div>
                        <div class="form-group col-3 p-2 mb-0">
                            <label class="col-form-label text-right" for="status">Trạng Thái </label>
                            {!! \App\Models\Hotel\PostModel::slbStatus('inactive', $params) !!}
                            <div class="input-error"></div>
                        </div>
                        <div class="form-group col-12 p-2 mb-0">
                            <!-- Label Section -->
                        ...
                        <div class="row m-0  pt-2">
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <input type="text" class="form-control" id="meta_title" name="meta_title"
                                    placeholder="Nhập meta title" value="{{$params['item']['meta_title']}}">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="meta_keyword">Meta keyword</label>
                                <input type="text" class="form-control" id="meta_keyword" name="meta_keyword" value="{{$params['item']['meta_keyword']}}"
    ...
    <script>
        $(document).ready(function() {
            $('#admin-{{ $params['prefix'] }}-form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route($params['prefix'] . '.' . $params['controller'] . '.update', ['post' => $params['item']['id']]) }}",
                    data: formData,
                    headers: {
