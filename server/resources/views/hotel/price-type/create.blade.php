@extends('layout.app')
@section('title', 'Thêm mới loại giá')
@section('main')
                    ...
                    <div class="card-body">
                        <div class="row m-0 pt-2">
                            ...
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên loại giá" value="">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <div class="row col-12 clearfix p-2 ml-2" id="show_room_type"></div>
                            ...
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="price_setting" name="price_setting" value="0" checked>
                            ...
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input additional-fee" type="radio" id="additional_fee_0" name="additional_fee" value="0">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input additional-fee" type="radio" id="additional_fee_1" name="additional_fee" value="1" checked>
                                    <label class="custom-control-label" for="additional_fee_1">
                                       Tính phí
                                    </label>
                                </div>
                                <div class="input-group col-6 p-2">
                                    <input type="text" class="form-control adt-free number_format" id="adt_fees" name="adt_fees" required>
                            ...
                            <div class="col-12 p-2 mb-0">
                                ...
                                <div class="row">
                                    <div class="form-group col-6 p-2 mb-0">
                                        ...
                                        <input type="text" class="form-control" id="booking_date_min" name="booking_date_min" placeholder="Nhập số ngày đặt trước tối thiểu" value="">
                                    ...
                                    <div class="form-group col-6 p-2 mb-0">
                                        ...
                                        <input type="text" class="form-control" id="booking_date_max" name="booking_date_max" placeholder="Nhập số ngày đặt trước tối đa" value="">
                                        <div class="input-error"></div>
                                    </div>
                                    <div class="form-group col-6 p-2 mb-0">
                                        <label class="col-form-label text-right" for="nights_number_min">Số đêm tối thiểu</label>
                                        <input type="text" class="form-control" id="nights_number_min" name="nights_number_min" placeholder="Nhập số đêm tối thiểu" value="">
                                        <div class="input-error"></div>
                                    </div>
                                    <div class="form-group col-6 p-2 mb-0">
                                        <label class="col-form-label text-right" for="nights_number_max">Số đêm tối đa</label>
                                        <input type="text" class="form-control" id="nights_number_max" name="nights_number_max" placeholder="Nhập số đêm tối đa" value="">
                                        <div class="input-error"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                {!! \App\Models\Hotel\PriceTypeModel::slbStatus('inactive') !!}
                                <div class="input-error"></div>
                            </div>
                        </div>
                        <!-- /.card-body -->
...
$(formEl).find('.indicator-label').show()
                    ...
                    error: function(data) {
                        ...
                        for (x in data.responseJSON.errors) {
                            console.log( $('#' + x).parents('.form-group').find('.input-error'));
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data['roomType'], function(index, roomType) {
                            htmlRoom += '<div class="icheck-primary d-inline ml-4">';
