...
@php
    ...
    $items = $model['items'];
@endphp
@section('title', trans('Danh sách danh mục khách sạn'))
@section('main')
            ...
            <div class="card card-default">
                <div class="card-body p-2">
                    ...
                    <form class="form-horizontal" method="GET" enctype="multipart/form-data"
                        ...
                        <div class="row m-0 pt-2">
                            ...
                            <div class="form-group col-3 p-2 mb-0">
                                ...
                                {!! \App\Models\Hotel\HotelCategoryModel::slbStatus(@$params['status'], ['action' => @$params['action']]) !!}
                            </div>
                            <div class="form-group col-3 p-2 mb-0">
                                <label for="status" class="font-weight-normal">Loại</label>
                                {!! \App\Models\Hotel\HotelCategoryModel::selectType([$params['type'] ?? ''], false) !!}
                            </div>
                    ...
                    <div class="basic-data-table">
                        {!! \App\Models\Hotel\HotelCategoryModel::createTreeTable($params, $items->toTree()) !!}
                    </div>
                    @if (count($items) > 0)
                        {!! \App\Models\Hotel\HotelCategoryModel::paginateBackend($items, $params) !!}
                    @endif
