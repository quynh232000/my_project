...
@php
    $model      = $params['model'];
@endphp
@section('title', trans('Danh sách ngôn ngữ'))
@section('main')
                ...
                <form class="form-horizontal" method="GET" enctype="multipart/form-data" id="admin-form-{{$params['prefix']}}-{{$params['controller']}}" name="admin-form-{{$params['prefix']}}-{{$params['controller']}}">
                    <div class="row m-0 pt-2">
                        <div class="form-group col-3 p-2 mb-0">
                            ...
                            <input id="name" name="name" value="{{ isset($params['name']) && !empty($params['name']) ? $params['name'] : '' }}" type="text" class="form-control event-enter" placeholder="Nhập...">
                        </div>
                        <div class="form-group col-3 p-2 mb-0">
                            <label for="name_en" class="font-weight-normal">Tên EN</label>
                            <input id="name_en" name="name_en" value="{{ isset($params['name_en']) && !empty($params['name_en']) ? $params['name_en'] : '' }}" type="text" class="form-control event-enter" placeholder="Nhập...">
                        </div>
                        <div class="form-group col-3 p-2 mb-0">
                            <label for="code" class="font-weight-normal">Code</label>
                            <input id="code" name="code" value="{{ isset($params['code']) && !empty($params['code']) ? $params['code'] : '' }}" type="text" class="form-control event-enter" placeholder="Nhập...">
                        </div>
                        <div class="form-group col-3 mb-0">
                            <label class="col-form-label text-right" for="status">Trạng Thái </label>
                            {!! \App\Models\Hotel\LanguageModel::slbStatus(isset($params['status']) && !empty($params['status']) ? $params['status'] : '') !!}
                        ...
                        <div class="col-12 row">
                            ...
                            <div class="form-group col-3 p-2 mb-0">
                                ...
                                <input id="created_at" name="created_at" value="{{isset($params['created_at']) && !empty($params['created_at']) ? $params['created_at'] : ''}}" type="text" class="form-control event-enter" placeholder="Chọn ngày tạo">
                            </div>
                            <div class="form-group col-3 p-2 mb-0">
                            ...
                            <div class="form-group col-3 p-2 mb-0">
                                ...
                                <input id="updated_at" name="updated_at" value="{{isset($params['updated_at']) && !empty($params['updated_at']) ? $params['updated_at'] : ''}}" type="text" class="form-control event-enter" placeholder="Chọn ngày sửa">
                            </div>
                        </div>
                    </div>
                </form>
