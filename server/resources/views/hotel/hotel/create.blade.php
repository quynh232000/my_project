                    ...
                    <div class="card-body p-2">
                        <div class="row m-0  pt-2">
                            ...
                            <div class="form-group col-6 p-2 mb-0">
                                ...
                                <input type="time" class="form-control" id="time_checkin" name="time_checkin" placeholder="Nhập time_checkin" value="09:00">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="time_checkout">Giờ trả phòng</label>
                                <input type="time" class="form-control" id="time_checkout" name="time_checkout" placeholder="Nhập time_checkout" value="12:00">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="construction_year">Năm xây dựng</label>
                                <input type="number"  min="1900" max="2100" value="" id="construction_year" class="form-control"  name="construction_year" placeholder="Chọn năm">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0 star">
                                ...
                                <input type="range" class="custom-range" min="0" max="5" step="0.5" name="stars" value="0" id="customRange1">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="floor_count">Số tầng</label>
                                <input type="number" min="0" max="100" class="form-control" id="floor_count" name="floor_count" placeholder="Nhập số.." value="0">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="floor_count">Số phòng</label>
                                <input type="number" min="1" max="100" class="form-control" id="room_count" name="room_count" placeholder="Nhập số.." value="1">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="bar_count">Số quán bar</label>
                                <input type="number" min="0" max="100"  class="form-control" id="bar_count" name="bar_count" placeholder="Nhập số.." value="0">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="restaurant_count">Số nhà hàng</label>
                                <input type="number" class="form-control" id="restaurant_count" name="restaurant_count" placeholder="Nhập số.." value="0">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="language">Ngôn ngữ hỗ trợ</label>
                                <input type="text" class="form-control" id="language" name="language" placeholder="Nhập slug" value="Tiếng Việt, Tiếng Anh">
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="status">Danh mục</label>
                                {!! \App\Models\Hotel\HotelModel::selectCategory() !!}
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-6 p-2 mb-0">
                            ...
                            <div class="form-group col-12 p-2 mb-0">
                                <label class="col-form-label text-right" for="description">Mô tả <span style="color: red">(*)</span></label>
                ...
                <div class="col-12 col-md-4 border-right service_parent custom_scroll"  id="list_check">
                    ...
                    <div class="form-check border-bottom py-2">
                        ...
                        <label class="form-check-label fw-bold" for="check_all">
                            Chọn tất cả tiện ích ({{array_reduce($params['info']['services'], function($s,$item){return $s + count($item['children']??[]);},0)}})
                        </label>
                    </div>
                        ...
                        <div class="px-3 py-2 border-bottom service_parent service_group" data-service-id="{{ $parent['id'] }}">
                            ...
                            <div class="p-2 px-4">
                                @foreach ($parent['children'] ?? [] as $child)
                                    <div class="form-check">
                                        <input name="facility[{{$parent['id'].'_'.$child['id']}}]" data-type="check-item" value="{{ $child['id'] }}" class="form-check-input input_item" id="service_child_{{ $child['id'] }}" type="checkbox">
