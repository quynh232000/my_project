...
interface SelectCheckboxProps<TValue extends string = string> {
	...
	data?: TSelectColumn[];
	handleChangeData?: (data: TValue[]) => void;
	className?: string;
...
const SelectDisplayColumn = <TValue extends string>({
	controllerRenderProps,
	isIconChevronLight = false,
	...props
}: SelectCheckboxProps<TValue>) => {
...
SelectDisplayColumn.displayName = 'SelectCheckbox';
export default SelectDisplayColumn;
