                  ...
                  <div className='flex gap-4 p-3 cursor-pointer transition-all hover:bg-primary-50'>
                    ...
                    <div className='flex-1'>
                      ...
                      <div className='mt-3 flex justify-between group relative'>
						...
						<Button {...({} as any)} className="rounded-lg normal-case font-normal border min-w-[106px] text-center border-primary-500 px-3 py-2 text-primary-500 transition-all hover:bg-primary-50 hover:shadow-md">
							Đăng ký
						</Button>
						<DrawerSidebar />
					</div>
