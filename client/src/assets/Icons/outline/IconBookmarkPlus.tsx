...
const IconBookmarkPlus = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" {...props}>
		...
		/>
		<path d="M12 7L12 13" stroke={props.color||"#777E90"} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
		<path d="M15 10L9 10" stroke={props.color||"#777E90"} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
	</svg>
);
