...
const Item = React.forwardRef<HTMLDivElement, ItemProps>(
	(
		...
		const deletedAlbumIds = useAlbumHotelStore(
			(state) => state.deletedAlbumIds
		);
						...
						<div
							...
							<div
								...
								<Button
									...
									className={cn(
										'h-8 max-w-[100px] rounded-lg bg-white px-6 py-3 text-neutral-600 hover:bg-secondary-500 hover:text-white',
								...
								<Button
									...
									className={
										'h-8 min-w-min rounded-lg bg-white px-6 py-3 text-neutral-600 hover:bg-neutral-300 hover:text-white'
									}>
