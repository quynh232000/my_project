                    ...
                    <div class="card-body">
                        <div class="row m-0 pt-2">
                            <div class="card col-12 p-2 mb-0 mt-2">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6 p-2 mb-0">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên khuyến mãi" value="">
                                        <div class="input-error"></div>
                                    </div>
                                </div>
                                <label class="col-form-label text-left" for="type">Loại giá sẽ áp dụng</label>
                                <div class="custom-control custom-radio mt-2">
                                    <input class="custom-control-input disable" type="radio" id="all_price_types_0" name="all_price_types" value="1">
                                    <label class="custom-control-label" for="all_price_types_0">
                                      Tất cả loại giá
                                    </label>
                                </div>
                                <div class="custom-control custom-radio mt-2">
                                    <input class="custom-control-input disable" type="radio" id="all_price_types_1" name="all_price_types" value="0" checked>
                                ...
                                <div class="row clearfix p-2" id="show_price_type"></div>
                                <div class="input-error" id="all_price_types"></div>
                                <label class="col-form-label text-left" for="type">Loại phòng sẽ áp dụng</label>
                                <div class="custom-control custom-radio mt-2">
                                    <input class="custom-control-input disable" type="radio" id="all_room_types_0" name="all_room_types" value="1">
                                    <label class="custom-control-label" for="all_room_types_0">
                                      Tất cả loại phòng có loại giá đã chọn
                                    </label>
                                </div>
                                <div class="custom-control custom-radio mt-2">
                                    <input class="custom-control-input disable" type="radio" id="all_room_types_1" name="all_room_types" value="0" checked>
                            ...
                            <div class="card form-group col-12 p-2 mb-0 mt-2">
                                ...
                                <div class="custom-control custom-radio mt-2">
                                    <input class="custom-control-input promotion" type="radio" id="perNight" name="promotion" value="0" checked>
                                    <label class="custom-control-label" for="perNight">
                                        Mỗi đêm
                                    </label>
                                </div>
                                <div class="input-group col-3 p-2" id="per-night-group">
                                    <input type="number" class="form-control" id="per_night" name="discount_per_night" min="0" max="100">
                                    <div class="input-group-append">
                                        <div class="input-group-text">%</div>
                                    </div>
                                </div>
                                <div class="custom-control custom-radio mt-2">
                                    <input class="custom-control-input promotion" type="radio" id="firstNight" name="promotion" value="1">
                                    <label class="custom-control-label" for="firstNight">
                                        Đêm đầu tiên
                                    </label>
                                </div>
                                <div class="input-group col-3 p-2" id="first-night-group" style="display:none;">
                                    <input type="number" class="form-control" id="first_night" name="discount_first_night" min="0" max="100">
                                    <div class="input-group-append">
                                        <div class="input-group-text">%</div>
                                    </div>
                                </div>
                                <div class="custom-control custom-radio mt-2 mb-3">
                                    <input class="custom-control-input promotion" type="radio" id="specificDay" name="promotion" value="2">
                                ...
                                <div class="row">
                                    <div class="form-group col-4">
                                        ...
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" id="start_date" name="start_date" data-target="#reservationdate" value="">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input unlimit" id="end_date" name="end_date" data-target="#reservationdate1" value="">
                                    ...
                                    <div class="form-group col-4">
                                        <div class="icheck-primary d-inline p-2" style="position: absolute; top: 30px; left: 0; transform: translateY(0);">
                                            <input class="disable" type="checkbox" id="unlimit" name="unlimit" value="1">
                            ...
                            <div class="card form-group col-12 p-2 mb-0 mt-2">
                                ...
                                <div class="custom-control custom-switch">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="is_stackable" name="is_stackable" value="1">
                                ...
                                <div class="col-4">
                                    {!! \App\Models\Hotel\PromotionModel::slbStatus('inactive') !!}
                                    <div class="input-error"></div>
                                </div>
                            </div>
                        <!-- /.card-body -->
