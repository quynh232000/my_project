@extends('layout.app')
@section('title', 'Tạo mới thông tin')
@section('main')
<style>
                    ...
                    <div class="card-body">
                        <div class="row m-0 ">
                            <div class="form-group col-md-12 p-2 mb-0">
                                ...
                                {!! \App\Models\Hotel\PriorityModel::selectData($params['hotel_id'] ?? '','hotel_id') !!}
                            ...
                            <div class="form-group col-md-6 p-2 mb-0">
                                ...
                                <input type="number" class="form-control generate-slug" id="priority" name="priority" placeholder="Nhập.." value="">
                                <div class="input-error"></div>
                            </div>

                            <div class="form-group col-md-6 p-2 mb-0">
                                <label class="col-form-label text-right" for="">Trạng Thái</label>
                                {!! \App\Models\Hotel\PriorityModel::slbStatus('active') !!}
                                <div class="input-error"></div>
                            </div>
                            <div class="form-group col-md-12 p-2 mb-0">
                    ...
                    <div class="card-body">
                        <div class="row m-0 ">
                            <div class="form-group col-md-12 p-2 mb-0">
                                ...
                                {!! \App\Models\Hotel\PriorityModel::selectData($params['category_id'] ?? '','category_id') !!}
                                <div class="input-error"></div>
                            </div>

                            <div class="form-group col-md-12 p-2 mb-0">
                                <label class="col-form-label text-right" for="">Địa chỉ</label>
                                <input type="text" class="form-control generate-slug" id="address" name="address" placeholder="Nhập.." value="">
                                <div class="input-error"></div>
                            </div>
                            ...
                            <div class="col-1 row">
                                <div class="col-12 d-flex align-items-center" style="padding-top: 30px;">
                                    <div class="icheck-primary  d-inline ">
                                        <input type="checkbox" value="1"  name="is_country" id="is_country">
                                        <label for="is_country"></label>
                                    </div>
                                </div>
                                <div class="col-12 d-flex align-items-center" style="padding-top: 30px;">
                                    <div class="icheck-primary  d-inline ">
                                        <input type="checkbox" value="1"  name="is_city" id="is_city">
                                        <label for="is_city"></label>
                                    </div>
                                </div>
                                <div class="col-12 d-flex align-items-center" style="padding-top: 30px;">
                                    <div class="icheck-primary  d-inline ">
                                        <input type="checkbox" value="1"  name="is_district" id="is_district">
                                        <label for="is_district"></label>
                                    </div>
                                </div>
                                <div class="col-12 d-flex align-items-center" style="padding-top: 30px;">
                                    <div class="icheck-primary  d-inline ">
                                        <input type="checkbox" value="1"  name="is_ward" id="is_ward">
