...
@php
    $model = $params['model'];
@endphp
@section('title', trans('Quản lý tài khoản'))
@section('main')
                    ...
                    <form class="form-horizontal" method="GET" enctype="multipart/form-data"
                        ...
                        <div class="row m-0 pt-2">
                            ...
                            <div class="col-12 row">
                                ...
                                <div class="form-group p-2 col-3 mb-0">
                                    <label class="font-weight-normal" for="status">Trạng Thái </label>
                                    {!! \App\Models\Hotel\CustomerModel::slbStatus(
                            ...
                            <div class="col-12 row">
                                ...
                                <div class="form-group col-3 p-2 mb-0">
                                    ...
                                    <input id="created_at" name="created_at"
                                        ...
                                        type="text" class="form-control event-enter" placeholder="Chọn ngày tạo">
                                </div>
                                <div class="form-group col-3 p-2 mb-0">
                                ...
                                <div class="form-group col-3 p-2 mb-0">
                                    ...
                                    <input id="updated_at" name="updated_at"
                                        ...
                                        type="text" class="form-control event-enter" placeholder="Chọn ngày sửa">
                                </div>
                            </div>
