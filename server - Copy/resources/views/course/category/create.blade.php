                    ...
                    <form id="" class="form"
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="Enter Aa.." name="type" />
                                @error('type')
                             ...
                             <div class="fv-row mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="Enter Aa.." name="key" />
                                @error('key')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="fv-row mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="Enter Aa.." name="value" />
                                @error('value')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                             <div class="fv-row mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="Enter Aa.." name="description" />
                                @error('name')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
