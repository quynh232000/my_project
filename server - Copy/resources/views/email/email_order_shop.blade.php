...
<body>
    <h2>Bạn có đơn hàng mới từ Quin ecommerce</h2>

    <h3>Thông tin đơn hàng</h3>
    <hr>
    <h1>Đơn hàng: {{ $data['order']['id'] }}</h1>
        ...
        <div class="mail-order-success-wrapper">
            ...
            <div class="mail-order-success-content" style="padding: 32px 0;">
                <div class="mail-order-success-content-hello">
                    <p class="mail-order-success-content-title">Xin Chào cửa hàng: </p>
                    <span style="padding: 0 4px;"><strong>{{ $data['order']->shop->name }}</strong></span>
                </div>
                <div> Bạn có 1 đơn hàng mới tại Quin Ecommerce. Vui lòng xác nhận để hoàn thành đơn hàng.</div>
                ...
                <hr>
                <div class="" style="padding-top:10px"><strong>Danh sách sản phẩm</strong></div>
                <div>
