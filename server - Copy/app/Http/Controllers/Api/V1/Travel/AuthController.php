...
use App\Models\Api\V1\Travel\Country;
use App\Models\Api\V1\Travel\Province;
use App\Models\Api\V1\Travel\Response;
use App\Models\Api\V1\Travel\User;
...
class AuthController extends Controller
{
    ...
    public function forgotpassword(Request $request)
    {
        try {
            ...
            Mail::send("mail.api.v1.travel.mailchangepassword", ['data' => $data], function ($message) use ($data) {
