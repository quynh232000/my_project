...
use App\Http\Requests\Hotel\PromotionRequest;
use App\Models\Hotel\PromotionModel;
...
class PromotionController extends AdminController
{
    ...
    public function edit($id)
    {
        ...
        $this->_params['priceType']         = $this->model->getItem($this->_params, ['task' => "get-price-type"]);
