...
use App\Http\Requests\Hotel\PartnerRegisterRequest;
use App\Models\Hotel\PartnerRegisterModel;
use Illuminate\Http\Request;

class PartnerRegisterController extends AdminController
{
    public $model;
    ...
    public function update(PartnerRegisterRequest $request)
    {   
