...
class PromotionPriceTypeModel extends HmsModel
{
    ...
    public function saveItem($params = null, $options = null){
        ...
        if ($options['task'] == 'edit-item') {
           $idOlds      = self::where('promotion_id',$options['insert_id'])->pluck('price_type_id')->all();
    ...
    public function deleteItem($ids, $options = null){
        if ($options['task'] == 'delete-item') {
            self::where('promotion_id',$options['insert_id'])->whereIn('price_type_id',$ids)->delete();   
        }
    }
}
