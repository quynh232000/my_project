...
class CoinTransactionModel  extends AdminModel
{
    ...
    public function listItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-index") {
            ...
            $query                          = self::select(array_keys($this->_data['listField']))
                ->leftJoin($TABLE_USER . ' AS u3', 'u3.id', '=', $this->table . '.user_id');
    ...
    public function columnAmount($params, $field, $val)
    {
