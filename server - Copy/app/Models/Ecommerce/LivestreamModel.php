...
class LivestreamModel  extends AdminModel
{
    ...
    public function __construct($attributes = [])
    {
        ...
        $this->_data        = [
            'listField' => [
                $this->table . '.id'                => 'id',
                $this->table . '.thumbnail_url'         => 'Thumbnail',
                $this->table . '.name'              => 'Key',
                $this->table . '.title'              => 'Title',
                'u.full_name AS user_id'                 => 'Shop',
    ...
    public function listItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-index") {
            ...
            $TABLE_CATEGORY_POST = config('constants.table.ecommerce.TABLE_CATEGORY_POST');
            $query                          = self::select(array_keys($this->_data['listField']))
                ->leftJoin($TABLE_USER . ' AS u', 'u.id', '=', $this->table . '.user_id')
    ...
    public function columnThumbnail_url($params, $field, $val)
    {
